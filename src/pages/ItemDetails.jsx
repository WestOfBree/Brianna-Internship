            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="item_info">
                  <h2><Skeleton width={"200px"} height={"30px"} borderRadius={"5px"}/></h2>

                  <div className="item_info_counts">
                    <div className="item_info_views">
                      <i className="fa fa-eye"></i>
                      <Skeleton width={"60px"} height={"15px"} borderRadius={"5px"}/>
                    </div>
                    ...
                    <div className="mr40">
                      ...
                      <div className="item_author">
                        ...
                        <div className="author_list_info">
                          <Link to="/author"><Skeleton width={"100px"} height={"20px"} borderRadius={"5px"}/></Link>
                        </div>
                      </div>
                    </div>
                    <div></div>
                  ...
                  <div className="de_tab tab_simple">
                    ...
                    <div className="nft-item-price">
                      ...
                      <span><Skeleton width={"60px"} height={"15px"} borderRadius={"5px"}/></span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="no-bottom no-top" id="content">
        ...
        <section aria-label="section" className="mt90 sm-mt-0"> 
          <div className="container">
            <div className="row">
              <div className="col-md-6 text-center">  
                <img src={ItemDetails.nftImage} className="img-fluid img-rounded mb-sm-30 nft-image" alt=""/>
              </div>
              <div className="col-md-6">
                <div className="item_info">
